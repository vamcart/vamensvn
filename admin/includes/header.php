...
//  if (($_SESSION['customers_status']['customers_status_id'] == '0') && ($admin_access['configuration'] == '1')) echo '<li><span><img src="images/icons/16x16/configure.png" border="0" alt=""></span><a href="' . xtc_href_link(FILENAME_CONFIGURATION, 'gID=6', 'NONSSL') . '">' . BOX_CONFIGURATION_6 . '</a></li>' . "\n";
  ...
  if (($_SESSION['customers_status']['customers_status_id'] == '0') && ($admin_access['cache'] == '1')) echo '<li><span><img src="images/icons/16x16/configure.png" border="0" alt=""></span><a href="' . xtc_href_link(FILENAME_CACHE, '', 'NONSSL') . '">' . BOX_CACHE_FILES . '</a></li>' . "\n";
...
<?php
  ...
  if (($_SESSION['customers_status']['customers_status_id'] == '0') && ($admin_access['languages'] == '1')) echo '<li><span><img src="images/icons/16x16/home.png" border="0" alt=""></span><a href="http://vamshop.com" target="_blank">' . BOX_SUPPORT_SITE . '</a></li>' . "\n";
