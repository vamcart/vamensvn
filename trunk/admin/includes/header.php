...
<?php
  ...
  if (($_SESSION['customers_status']['customers_status_id'] == '0') && ($admin_access['parameters'] == '1')) echo '<li><a href="' . vam_href_link(FILENAME_PARAMETERS, '', 'NONSSL') . '">' . BOX_PARAMETERS . '</a><b class="p4"></b></li>' . "\n";
  if (($_SESSION['customers_status']['customers_status_id'] == '0') && ($admin_access['parameters'] == '1')) echo '<li><a href="' . vam_href_link(FILENAME_PARAMETERS_EXPORT, '', 'NONSSL') . '">' . BOX_PARAMETERS_EXPORT . '</a><b class="p4"></b></li>' . "\n";
...
<?php
  ...
  if (($_SESSION['customers_status']['customers_status_id'] == '0') && ($admin_access['languages'] == '1')) echo '<li><a href="http://vamshop.com" target="_blank">' . BOX_SUPPORT_SITE . '</a><b class="p4"></b></li>' . "\n";
  if (($_SESSION['customers_status']['customers_status_id'] == '0') && ($admin_access['languages'] == '1')) echo '<li><a href="http://vamshop.com/faq" target="_blank">' . BOX_SUPPORT_FAQ . '</a><b class="p4"></b></li>' . "\n";
  if (($_SESSION['customers_status']['customers_status_id'] == '0') && ($admin_access['languages'] == '1')) echo '<li><a href="http://vamshop.com/forum" target="_blank">' . BOX_SUPPORT_FORUM . '</a><b class="p4"></b></li>' . "\n";
