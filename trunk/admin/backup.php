<?php
/* --------------------------------------------------------------
   $Id: cache.php,v 1.1 2010-11-08 11:13:01Z VaM $   
    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="2">
      <tr>
        <td><table width="100%" cellspacing="0" cellpadding="0">
          <tr>
        		<td align="left">
          		<iframe frameborder="0" width="100%" height="500" align="left" src="sxd/backup.php?lang=<?php echo $_SESSION['language_code']; ?>&<?php echo session_name() . '=' . session_id(); ?>"></iframe>
        		</td>
          </tr>
        </table></td>
      </tr>
