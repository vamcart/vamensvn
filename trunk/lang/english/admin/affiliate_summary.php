...
define('TEXT_AMOUNT_HELP', '<i>Amount</i> represents the total sales value of delivered orders accredited to you.');
...
define('TEXT_COMMISSION_HELP', '<i>Commission</i>  represents the total commission of delivered orders owed to you');
