<?php
/* -----------------------------------------------------------------------------------------
   $Id: coupon_admin.php 899 2007-02-07 17:36:57 VaM $
   ...
   (c) 2004	 xt:Commerce (coupon_admin.php,v 1.1.2.5 2003/05/13); xt-commerce.com
...
define('BUTTON_SEND_MAIL','Send');
define('ERROR_NO_COUPON_AMOUNT','No Coupon Amount');
