...
------------------------------------------------------------------------------*/
  ...
  define('TEXT_CVV', '<span class="bold">Visa, Mastercard, Discover 3 Digit Card Verification Number</span><br />For your safety and security, we require that you enter your card\'s verification number. The verification number is a 3-digit number printed on the back of your card. It appears after and to the right of your card number\'s last four digits.<br /><img src="images/cv_card.gif" alt="" /><br /><span class="bold">American Express 4 Digit Card Verification Number</span><br />For your safety and security, we require that you enter your card\'s verification number. The American Express verification number is a 4-digit number printed on the front of your card. It appears after and to the right of your card number.<br /><img src="images/cv_amex_card.gif" alt="" /><br />');
