<?php
/* -----------------------------------------------------------------------------------------
   $Id: english.php 1260 2017/08/09 15:10:51 VaM $
...
define('IMAGE_BUTTON_IN_CART_IN', 'Added to cart');
define('IMAGE_BUTTON_IN_WISHLIST', 'Add to wishlist');
define('IMAGE_BUTTON_IN_WISHLIST_IN', 'Added to wishlist');
...
define('RETAIL_PRICE','');
define('GROUP_PRICE','');
define('MANUFACTURER_DISCOUNT','Sale ');
define('CATEGORY_DISCOUNT','Sale ');
define('BRAND_DISCOUNT','Sale ');
define('PRODUCT_DISCOUNT','Sale ');
define('PERSONAL_DISCOUNT','Sale ');
...
define('TEXT_SCHET_1','Store');
define('TEXT_SCHET_2','Address');
define('TEXT_SCHET_3','Phone');
define('TEXT_SCHET_4','Fax');
define('TEXT_SCHET_5','R/S');
define('TEXT_SCHET_6','bank');
define('TEXT_SCHET_7','K/S');
define('TEXT_SCHET_8','BIK');
define('TEXT_SCHET_9','INN');
define('TEXT_SCHET_10','KPP');
define('TEXT_SCHET_11','OGRN');
define('TEXT_SCHET_12','OKPO');
define('TEXT_SCHET_13','Customer');
define('TEXT_SCHET_14','Shipping:');
define('TEXT_SCHET_15','Phone:');
define('TEXT_SCHET_16','E-Mail:');
define('TEXT_SCHET_17','Invoice #');
define('TEXT_SCHET_18','#');
define('TEXT_SCHET_19','#');
define('TEXT_SCHET_20','Product Name');
define('TEXT_SCHET_21','Quantity');
define('TEXT_SCHET_22','Price');
define('TEXT_SCHET_23','Total');
define('TEXT_SCHET_24','Total:');
define('TEXT_SCHET_25','No VAT.');
define('TEXT_SCHET_26','CEO');
define('TEXT_SCHET_27','Lastname');
define('TEXT_SCHET_28','Accountant');
define('TEXT_SCHET_29','MP');
define('TEXT_SCHET_30','');

define('TEXT_PACKINGSLIP_1','Store:');
define('TEXT_PACKINGSLIP_2','Address');
define('TEXT_PACKINGSLIP_3','Phone');
define('TEXT_PACKINGSLIP_4','Fax');
define('TEXT_PACKINGSLIP_5','R/S');
define('TEXT_PACKINGSLIP_6','bank');
define('TEXT_PACKINGSLIP_7','K/S');
define('TEXT_PACKINGSLIP_8','BIK');
define('TEXT_PACKINGSLIP_9','INN');
define('TEXT_PACKINGSLIP_10','KPP');
define('TEXT_PACKINGSLIP_11','OGRN');
define('TEXT_PACKINGSLIP_12','OKPO');
define('TEXT_PACKINGSLIP_13','Customer');
define('TEXT_PACKINGSLIP_14','Shipping:');
define('TEXT_PACKINGSLIP_15','Phone:');
define('TEXT_PACKINGSLIP_16','E-Mail:');
define('TEXT_PACKINGSLIP_17','Packingslip #');
define('TEXT_PACKINGSLIP_18','#');
define('TEXT_PACKINGSLIP_19','Model');
define('TEXT_PACKINGSLIP_20','Product name');
define('TEXT_PACKINGSLIP_21','Quantity');
define('TEXT_PACKINGSLIP_22','Price');
define('TEXT_PACKINGSLIP_23','Total');
define('TEXT_PACKINGSLIP_24','Total:');
define('TEXT_PACKINGSLIP_25','No VAT.');
define('TEXT_PACKINGSLIP_26','CEO');
define('TEXT_PACKINGSLIP_27','Lastname');
define('TEXT_PACKINGSLIP_28','Customer');
