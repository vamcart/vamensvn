...
/*
	...
	Filename: languages/.../modules/shipping/russianpostprepay.php
	~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	Написано Igel'ем.
	igel@weblight.us
	ICQ: 9006615
...
define('MODULE_SHIPPING_RUSSIANPOSTPREPAY_TEXT_WAY_WRAPPER', 'Цена доставки бандеролью, при <i>предварительной оплате</i> заказа.');
define('MODULE_SHIPPING_RUSSIANPOSTPREPAY_TEXT_WAY_COUNTRY', 'Цена доставки международным почтовым отправлением, при <i>предварительной оплате</i> заказа.');
define('MODULE_SHIPPING_RUSSIANPOSTPREPAY_TEXT_UNITS', 'кг.');
define('MODULE_SHIPPING_RUSSIANPOSTPREPAY_UNDEFINED_RATE', 'В данный момент доставка службой &laquo;Почта России&raquo; невозможна.');

define('MODULE_SHIPPING_RUSSIANPOSTPREPAY_WRAPPER_NEED', '');//Заказ будет разбит на X бандерол(ь,и,ей)
define('MODULE_SHIPPING_RUSSIANPOSTPREPAY_WRAPPER_1', 'бандероль');
define('MODULE_SHIPPING_RUSSIANPOSTPREPAY_WRAPPER_2', 'бандероли');
define('MODULE_SHIPPING_RUSSIANPOSTPREPAY_WRAPPER_5', 'бандеролей');

define('MODULE_SHIPPING_RUSSIANPOSTPREPAY_PARCEL_NEED', '');//Заказ будет разбит на X посылк(у,и,ок)
define('MODULE_SHIPPING_RUSSIANPOSTPREPAY_PARCEL_1', 'посылка');
define('MODULE_SHIPPING_RUSSIANPOSTPREPAY_PARCEL_2', 'посылки');
define('MODULE_SHIPPING_RUSSIANPOSTPREPAY_PARCEL_5', 'посылок');

define('MODULE_SHIPPING_RUSSIANPOSTPREPAY_INTER_NEED', '');//Заказ будет разбит на X посылк(у,и,ок)
define('MODULE_SHIPPING_RUSSIANPOSTPREPAY_INTER_1', 'посылка');
define('MODULE_SHIPPING_RUSSIANPOSTPREPAY_INTER_2', 'посылки');
define('MODULE_SHIPPING_RUSSIANPOSTPREPAY_INTER_5', 'посылок');
