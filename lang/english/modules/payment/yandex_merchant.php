...
/* -----------------------------------------------------------------------------------------
  ...
  define('MODULE_PAYMENT_YANDEX_MERCHANT_TEXT_TITLE', 'Yandex.Kassa');
  define('MODULE_PAYMENT_YANDEX_MERCHANT_TEXT_PUBLIC_TITLE', 'Yandex.Kassa');
  ...
  define('MODULE_PAYMENT_YANDEX_MERCHANT_TEXT_ADMIN_DESCRIPTION', 'Как правильно настроить модуль оплаты Яндекс.Касса читайте в нашем <a href="http://blog.vamshop.ru/2014/02/20/настройка-модуля-оплаты-яндекс-деньг"><u>блоге</u></a>.');
...
define('MODULE_PAYMENT_YANDEX_MERCHANT_SEND_CHECK_TITLE' , 'Отправлять в Яндекс.Кассу данные для чеков (54-ФЗ)');
