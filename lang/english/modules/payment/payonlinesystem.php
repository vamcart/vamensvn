...
define('MODULE_PAYMENT_PAYONLINESYSTEM_TEXT_TITLE', 'WebMoney Merchant');
define('MODULE_PAYMENT_PAYONLINESYSTEM_TEXT_PUBLIC_TITLE', 'WebMoney Merchant');
define('MODULE_PAYMENT_PAYONLINESYSTEM_TEXT_ADMIN_DESCRIPTION', 'Модуль оплаты WebMoney Merchant<br />Как правильно настроить модуль читайте <a href="http://vamshop.ru/faq.php/faq_id/70/question/Nastroika-modulya-oplaty-WebMoney-Merchant" target="_blank"><u>здесь</u></a>.');
...
define('MODULE_PAYMENT_PAYONLINESYSTEM_STATUS_TITLE' , 'Разрешить модуль WebMoney');
...
define('MODULE_PAYMENT_PAYONLINESYSTEM_ID_TITLE' , 'WM ID:');
define('MODULE_PAYMENT_PAYONLINESYSTEM_ID_DESC' , 'Укажите Ваш WM ID');
define('MODULE_PAYMENT_PAYONLINESYSTEM_WMR_TITLE' , 'Ваш WMR кошелёк:');
define('MODULE_PAYMENT_PAYONLINESYSTEM_WMR_DESC' , 'Укажите номер Вашего WMR кошелька');
...
define('MODULE_PAYMENT_PAYONLINESYSTEM_SECRET_KEY_DESC' , 'В данной опции укажите Ваш ключ, указанный в опции Secret Key на сайте WebMoney Merchant.');
