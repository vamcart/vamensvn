...
define('BOX_CONFIGURATION_90', 'Social Networks');
define('BOX_CONFIGURATION_100', '1C:Enterprise');
...
define('VAMSHOP_SUPPORT_KEY_TEXT','');
define('VAMSHOP_REGISTER_SUPPORT_KEY','');
