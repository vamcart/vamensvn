...
define('AJAX_CART_DESC','Use ajax shopping cart (true) or standard shopping cart (false).');
define('AJAX_WISHLIST_TITLE','Ajax wishlist');
define('AJAX_WISHLIST_DESC','Use ajax wishlist (true) or standard wishlist (false).');
...
define('MAX_DISPLAY_WISHLIST_TITLE' , 'Length of products name in wishlist box');
define('MAX_DISPLAY_WISHLIST_DESC' , 'Length of products name in wishlist box');
...
define('MODULE_ORDER_STATUS_HAVE_TITLE' , 'Orders with current status');
define('MODULE_ORDER_STATUS_TITLE' , 'New order status');
define('MODULE_ORDER_STATUS_DESC' , 'Setup new order status for matching orders.');
define('MODULE_ORDER_STATUS_HAVE_DESC' , 'Current status of the order');
...
define('MODULE_ORDER_STATUS_HAVE_2_TITLE' , 'Orders with current status');
define('MODULE_ORDER_STATUS_HAVE_2_DESC' , 'Current status of the order');
define('MODULE_ORDER_STATUS_2_TITLE' , 'New order status');
define('MODULE_ORDER_STATUS_2_DESC' , 'Setup new order status for matching orders.');
...
define('MODULE_ORDER_STATUS_HAVE_3_TITLE' , 'Orders with current status');
define('MODULE_ORDER_STATUS_HAVE_3_DESC' , 'Current status of the order');
define('MODULE_ORDER_STATUS_3_TITLE' , 'New order status');
define('MODULE_ORDER_STATUS_3_DESC' , 'Setup new order status for matching orders.');
...
define('MODULE_ORDER_STATUS_HAVE_4_TITLE' , 'Orders with current status');
define('MODULE_ORDER_STATUS_HAVE_4_DESC' , 'Current status of the order');
define('MODULE_ORDER_STATUS_4_TITLE' , 'New order status');
define('MODULE_ORDER_STATUS_4_DESC' , 'Setup new order status for matching orders.');
...
define('MODULE_ORDER_STATUS_HAVE_5_TITLE' , 'Orders with current status');
define('MODULE_ORDER_STATUS_HAVE_5_DESC' , 'Current status of the order');
define('MODULE_ORDER_STATUS_5_TITLE' , 'New order status');
define('MODULE_ORDER_STATUS_5_DESC' , 'Setup new order status for matching orders.');
...
define('MODULE_ORDER_STATUS_HAVE_6_TITLE' , 'Orders with current status');
define('MODULE_ORDER_STATUS_HAVE_6_DESC' , 'Current status of the order');
