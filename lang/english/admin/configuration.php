<?php
/* -----------------------------------------------------------------------------------------
   $Id: configuration.php 1286 2008-02-13 17:36:59 VaM $
...
define('BOX_CATEGORIES_TITLE', 'Categories');
define('BOX_CONTENT_TITLE', 'More about');
define('BOX_INFORMATION_TITLE', 'Informations');
define('BOX_ADD_QUICKIE_TITLE', 'Quick purchase');
define('BOX_LAST_VIEWED_TITLE', 'Last viewed');
define('BOX_REVIEWS_TITLE', 'Reviews');
define('BOX_SEARCH_TITLE', 'Search');
define('BOX_SPECIALS_TITLE', 'Special offers');
define('BOX_FEATURED_TITLE', 'Featured products');
define('BOX_LATESTNEWS_TITLE', 'News');
define('BOX_ARTICLES_TITLE', 'Articles');
define('BOX_ARTICLESNEW_TITLE', 'New articles');
define('BOX_AUTHORS_TITLE', 'Authors');
define('BOX_CART_TITLE', 'Shopping Cart');
define('BOX_LOGIN_TITLE', 'Welcome back');
define('BOX_ADMIN_TITLE', 'Admin Info');
define('BOX_DOWNLOADS_TITLE', 'My downloads');
define('BOX_AFFILIATE_TITLE', 'Affiliate Program');
define('BOX_WHATSNEW_TITLE', 'New Products');
define('BOX_NEWSLETTER_TITLE', 'Newsletter Subscribing');
define('BOX_BESTSELLERS_TITLE', 'Best seller');
define('BOX_INFOBOX_TITLE', 'Info');
define('BOX_CURRENCIES_TITLE', 'Currencies');
define('BOX_LANGUAGES_TITLE', 'Languages');
define('BOX_MANUFACTURERS_TITLE', 'Manufacturer');
define('BOX_MANUFACTURERS_INFO_TITLE', 'Information about manufacturer');
define('BOX_FAQ_TITLE', 'FAQ');

define('BOX_CATEGORIES_DESC', 'Enable/Disable box.');
define('BOX_CONTENT_DESC', 'Enable/Disable box.');
define('BOX_INFORMATION_DESC', 'Enable/Disable box.');
define('BOX_ADD_QUICKIE_DESC', 'Enable/Disable box.');
define('BOX_LAST_VIEWED_DESC', 'Enable/Disable box.');
define('BOX_REVIEWS_DESC', 'Enable/Disable box.');
define('BOX_SEARCH_DESC', 'Enable/Disable box.');
define('BOX_SPECIALS_DESC', 'Enable/Disable box.');
define('BOX_FEATURED_DESC', 'Enable/Disable box.');
define('BOX_LATESTNEWS_DESC', 'Enable/Disable box.');
define('BOX_ARTICLES_DESC', 'Enable/Disable box.');
define('BOX_ARTICLESNEW_DESC', 'Enable/Disable box.');
define('BOX_AUTHORS_DESC', 'Enable/Disable box.');
define('BOX_CART_DESC', 'Enable/Disable box.');
define('BOX_LOGIN_DESC', 'Enable/Disable box.');
define('BOX_ADMIN_DESC', 'Enable/Disable box.');
define('BOX_DOWNLOADS_DESC', 'Enable/Disable box.');
define('BOX_AFFILIATE_DESC', 'Enable/Disable box.');
define('BOX_WHATSNEW_DESC', 'Enable/Disable box.');
define('BOX_NEWSLETTER_DESC', 'Enable/Disable box.');
define('BOX_BESTSELLERS_DESC', 'Enable/Disable box.');
define('BOX_INFOBOX_DESC', 'Enable/Disable box.');
define('BOX_CURRENCIES_DESC', 'Enable/Disable box.');
define('BOX_LANGUAGES_DESC', 'Enable/Disable box.');
define('BOX_MANUFACTURERS_DESC', 'Enable/Disable box.');
define('BOX_MANUFACTURERS_INFO_DESC', 'Enable/Disable box.');
define('BOX_FAQ_DESC', 'Enable/Disable box.');
