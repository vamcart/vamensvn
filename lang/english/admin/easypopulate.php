...
define('TEXT_EASYPOPULATE_LABEL_QUANTITY_MAX','max quantity');
define('TEXT_EASYPOPULATE_LABEL_LENGTH','length');
define('TEXT_EASYPOPULATE_LABEL_WIDTH','width');
define('TEXT_EASYPOPULATE_LABEL_HEIGHT','height');
define('TEXT_EASYPOPULATE_LABEL_VOLUME','volume');
