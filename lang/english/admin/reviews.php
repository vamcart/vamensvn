<?php
/* --------------------------------------------------------------
   $Id: reviews.php 899 2007-02-07 17:36:57 VaM $
   ...
   (c) 2004	 xt:Commerce (reviews.php,v 1.4 2003/08/14); xt-commerce.com
...
define('TABLE_HEADING_NAME', 'Author');
...
define('ENTRY_REVIEW_ANSWER', 'Answer:');
define('ENTRY_REVIEW_TEXT', '<small><font color="#ff0000"><b>NOTE:</b></font></small>&nbsp;HTML is not translated!&nbsp');
define('ENTRY_RATING', 'Rating:');
...
define('REVIEW_ANSWER_SUBJECT','Added a reply to your review!');
?>