<?php
/* --------------------------------------------------------------
   $Id: customers.php 1295 2007-02-07 17:36:57 VaM $
   ...
   (c) 2004	 xt:Commerce (customers.php,v 1.8 2003/08/15); xt-commerce.com
...
define('ENTRY_DISCOUNT','Personal discount:');
define('ENTRY_DISCOUNT_CUSTOMER','Personal discount:');
define('ENTRY_DISCOUNT_CUSTOMER_TO_MANUFACTURER','Personal manufacturer <br /> discount:');
