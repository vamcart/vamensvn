...
INSERT INTO configuration (configuration_key, configuration_value, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES ('ACCOUNT_STREET_ADDRESS', 'true', 5, 6, NULL, '', NULL, 'vam_cfg_select_option(array(\'true\', \'false\', \'optional\'),');
INSERT INTO configuration (configuration_key, configuration_value, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES ('ACCOUNT_CITY', 'true', 5, 7, NULL, '', NULL, 'vam_cfg_select_option(array(\'true\', \'false\', \'optional\'),');
INSERT INTO configuration (configuration_key, configuration_value, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES ('ACCOUNT_POSTCODE', 'true', 5, 8, NULL, '', NULL, 'vam_cfg_select_option(array(\'true\', \'false\', \'optional\'),');
INSERT INTO configuration (configuration_key, configuration_value, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES ('ACCOUNT_COUNTRY', 'true', 5, 9, NULL, '', NULL, 'vam_cfg_select_option(array(\'true\', \'false\', \'optional\'),');
...
INSERT INTO configuration (configuration_key, configuration_value, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES ('ACCOUNT_STATE', 'true',  5, 14, NULL, '', NULL, 'vam_cfg_select_option(array(\'true\', \'false\', \'optional\'),');
